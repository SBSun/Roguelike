...
public class PlayerTouchingWallState : PlayerState
{
    ...
    public PlayerTouchingWallState(Player player, PlayerStateMachine stateMachine, SO_PlayerData SO_PlayerData, string animBoolName) : base(player, stateMachine, SO_PlayerData, animBoolName)
    {
    }
