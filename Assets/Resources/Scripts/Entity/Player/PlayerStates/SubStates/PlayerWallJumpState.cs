...
public class PlayerWallJumpState : PlayerAbilityState
{
    ...
    public PlayerWallJumpState(Player player, PlayerStateMachine stateMachine, SO_PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
