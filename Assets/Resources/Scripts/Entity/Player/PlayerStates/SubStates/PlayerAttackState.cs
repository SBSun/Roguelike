...
public class PlayerAttackState : PlayerAbilityState
{
    ...
    public PlayerAttackState(Player player, PlayerStateMachine stateMachine, SO_PlayerData SO_PlayerData, string animBoolName) : base(player, stateMachine, SO_PlayerData, animBoolName)
    {
    }
